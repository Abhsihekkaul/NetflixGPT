...
const Header = () => {
  return (
    // absolute is trying to overlap or making the below thing to merge into its parent
    <div className='absolute w-screen px-25 py-2 bg-gradient-to-b from-black z-2'>
